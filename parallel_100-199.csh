...
set current = 100         # 起始任务编号
set lock_dir = "/nfs/share/home/tongliu/processordataset/script-eval/lock_2"  # 锁目录（使用PID防冲突）
set log_file = "/nfs/share/home/tongliu/processordataset/script-eval/parallele100-199.log"  # 日志文件
# 初始化日志系统
